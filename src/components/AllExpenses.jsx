  ...
  <tr>
    <td className="p-2 whitespace-nowrap">
      <div className="flex items-center">
        ...
        <div className="font-medium text-zinc-900 ml-2">Rent</div>
      </div>
    </td>
    <td className="p-2 whitespace-nowrap">Housing</td>
    <td className="p-2 whitespace-nowrap">2024-03-27</td>
    <td className="p-2 whitespace-nowrap">
      <div className="text-center font-medium text-orange-300">$2,890.66</div>
    </td>
    <td className="p-2 whitespace-nowrap flex items-center justify-center"><Link to=" " > <CiEdit className='w-6 h-6 text-teal-800'/> </Link></td>
  </tr>
  <tr>
    <td className="p-2 whitespace-nowrap">
      <div className="flex items-center">
        <div className="w-10 h-10 shadow-md  bg-teal-800 rounded-full flex items-center justify-center">< FaShoppingCart className='h-6 w-6  text-gray-100' /></div>
        <div className="font-medium text-zinc-900  ml-2">Groceries</div>
      </div>
    </td>
    <td className="p-2 whitespace-nowrap">Food</td>
    <td className="p-2 whitespace-nowrap">2024-03-28</td>
    <td className="p-2 whitespace-nowrap">
      <div className="text-center font-medium text-orange-300">$200.00</div>
    </td>
    <td className="p-2 whitespace-nowrap flex items-center justify-center"><Link to=" " > <CiEdit className='w-6 h-6 text-teal-800'/> </Link></td>
  </tr>
  <tr>
    <td className="p-2 whitespace-nowrap">
      <div className="flex items-center">
        <div className="w-10 h-10 shadow-md  bg-teal-800 rounded-full flex items-center justify-center">< ImConnection className='h-6 w-6  text-gray-100' /></div>
        <div className="font-medium text-zinc-900 ml-2">Internet</div>
      </div>
    </td>
    <td className="p-2 whitespace-nowrap">Utilities</td>
    <td className="p-2 whitespace-nowrap">2024-03-29</td>
    <td className="p-2 whitespace-nowrap">
      <div className="text-center font-medium text-orange-300">$50.00</div>
    </td>
    <td className="p-2 whitespace-nowrap flex items-center justify-center"><Link to=" " > <CiEdit className='w-6 h-6 text-teal-800'/> </Link></td>
  </tr>
  <tr>
